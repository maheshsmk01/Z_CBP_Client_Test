  METHOD def_a_insp_sample_result_type.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'A_INSP_SAMPLE_RESULT_TYPE'
                                    is_structure              = VALUE tys_a_insp_sample_result_type( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'A_InspSampleResultType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'A_INSP_SAMPLE_RESULT' ).
    lo_entity_set->set_edm_name( 'A_InspSampleResult' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'INSP_RESULT_NMBR_OF_RECORD' ).
    lo_primitive_property->set_edm_name( 'InspResultNmbrOfRecordedRslts' ) ##NO_TEXT.
